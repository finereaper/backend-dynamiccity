...
<head>
    ...
    <title>Password Reset - Dynamic City</title>
</head>
        ...
        <section id="introSection">
            <div class="container" style="padding: 50px 0px;">
                <div id="introBlock"
                    ...
                    <h2 id="loginHeader">Wachtwoord Reset</h2>
                    @if (session('status'))
                        <div class="alert alert-success">
                            {{ session('status') }}
                        </div>
                    @endif
                    <form id="loginForm" action="wachtwoordreset" method="post">
                        {{ csrf_field() }}
                        <p class="inputDesc">E-mail adres</p><input type="email" name="gebruikerGebruikersnaam"
                                                                    placeholder="E-mail adres">
                        <input class="button" type="submit" name="wachtwoord_Reset" value="Reset Wachtwoord">
                    </form>
                </div>
            </div>
        </section>
