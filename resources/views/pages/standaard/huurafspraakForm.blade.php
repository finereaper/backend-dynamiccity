...
<head>
    ...
    <title>Huurafspraak afwijzen - Dynamic City</title>
    <!--favicon link -->
    <link rel="apple-touch-icon" sizes="180x180" href="/public/assets/favicon/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="/public/assets/favicon/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="/public/assets/favicon/favicon-16x16.png">
        ...
        <section id="introSection" style="background-image: none !important;">
            <div class="container" style="padding: 50px 0px;">
                <div id="pandInfoBlok" class="col-md-offset-1 col-md-10 col-sm-offset-2 col-sm-8 col-xs-offset-1 col-xs-10">
                    <h2 align="center" style="color: white">Afspraak afwijzen</h2>
                    <form action="" method="post">
                        {{ csrf_field() }}
                        <textarea id="afwijsText" name="gebruikerReden">
                                </textarea>
                        <input class="afwijsButton" name="gebruikerSubmit" type="submit" value="Verstuur Bericht">
                    </form>
                </div>
            </div>
        </section>
