        ...
        <section id="introSection">
            <div class="container" style="padding: 50px 0px;">
                <div id="introBlock" class="col-md-offset-4 col-md-4 col-sm-offset-2 col-sm-8 col-xs-offset-1 col-xs-10">
                    ...
                    <a href="/info"><button type="button">Lees meer</button></a><br>
                    <div class="fb-like" data-href="https://www.facebook.com/DynamicCityNL/?fref=nf" data-layout="button_count" data-action="like" data-size="large" data-show-faces="false" data-share="false"></div>
                </div>
            </div>
        </section>
