...
<head>
    ...
    <title>Pand toevoegen - Dynamic City</title>
    <!--favicon link -->
    <link rel="apple-touch-icon" sizes="180x180" href="/public/assets/favicon/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="/public/assets/favicon/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="/public/assets/favicon/favicon-16x16.png">
        ...
        <section id="introSection">
            <div class="container" style="padding: 50px 0px;">
                <div id="introBlock"
                    ...
                    <h2 id="loginHeader">Pand Toevoegen</h2>
                    <form action="toevoegen" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <p class="regLabel">Oppervlakte</p>     <input class="smallInput" type="number"
                                                                       name="pandOppervlakte">
                        <p class="regLabel">Omschrijving</p>      <input class="smallInput" type="text"
                                                                         name="pandOmschrijving">
                        <p class="regLabel">Straat</p>    <input class="smallInput" type="text" name="pandStraat">
                        <p class="regLabel">Postcode</p>   <input class="smallInput" type="text" name="pandPostcode">
                        <p class="regLabel">Stad</p>    <input class="smallInput" type="text" name="pandStad">
                        <p class="regLabel">Prijs</p>  <input class="smallInput" type="number" name="pandPrijs">
                        <p class="regLabel">Ligging</p>        <input class="smallInput" type="text" name="pandLigging">
                        <p class="regLabel">Status</p>        <input class="smallInput" type="text" name="pandStatus">
                        <p class="regLabel">Aantal plekken</p>        <input class="smallInput" type="number"
                                                                             name="pandPlekken">
                        <p class="regLabel">Foto</p>        <input class="smallInput" name="pandPhotos[]" type="file"
                                                                   multiple>

                        <input class="button" type="submit" name="Toevoegen" value="Toevoegen">
                    </form>
                </div>
            </div>
        </section>
