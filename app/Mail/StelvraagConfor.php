...
class StelvraagConfor extends Mailable
{
    ...
    {
        return $this->view('pages.mail.stelvraagConfor', compact('verhuurder_Naam', 'gebruiker_Email', 'gebruiker_Message','pand_Straat'));
    }
}
